  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <h1 className="text-3xl font-bold text-foreground text-glow whitespace-nowrap">Phones</h1>
        ...
        <div className="flex-1">
          {filteredPhones.length > 0 ? (
            ...
            <div className="text-center py-20 glass-card rounded-lg">
              <p className="text-muted-foreground">No phones match your current filters.</p>
              <button
