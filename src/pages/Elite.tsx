    ...
    return (
        <div className="container mx-auto px-4 py-12 md:py-24 animate-fade-in">
            ...
            <div className="text-center mb-20 max-w-3xl mx-auto">
                ...
                <h1 className="text-4xl md:text-7xl font-black bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent mb-6 tracking-tighter animate-shimmer">
                    Elevate Your Tech Experience
                </h1>
                <p className="text-lg md:text-xl text-muted-foreground font-medium animate-slide-up stagger-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
                {[
                    ...
                    <div
                        key={i}
                        className={`p-8 rounded-[2.5rem] bg-white border border-border hover:border-primary/20 hover:shadow-2xl hover:shadow-primary/5 transition-all duration-500 group animate-slide-up stagger-${(i % 3) + 1}`}
                    >
            ...
            {/* CTA Section */}
            <div className="glass-morphism rounded-[3rem] p-12 md:p-24 text-center relative overflow-hidden border border-primary/20 bg-white/40 mb-20">
                ...
                <div className="relative z-10 max-w-2xl mx-auto">
                    <h2 className="text-3xl md:text-5xl font-black text-foreground mb-6 tracking-tighter">Ready to Become Elite?</h2>
                    ...
                    <p className="text-[10px] text-muted-foreground px-12 mt-6 uppercase font-bold tracking-widest leading-loose">
