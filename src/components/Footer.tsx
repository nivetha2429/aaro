...
const Footer = () => (
  <footer className="bg-background border-t border-border mt-1 md:mt-4 pb-20 lg:pb-10">
    <div className="container mx-auto px-3 sm:px-4 lg:px-6 xl:px-8 py-5 sm:py-8 pb-16 lg:pb-8">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8 text-center md:text-left">
        <div>
          <div className="flex items-center justify-center md:justify-start gap-2 mb-3 sm:mb-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-x-1 gap-y-1.5 sm:gap-x-2 sm:gap-y-3 text-[11px] sm:text-sm font-bold justify-items-center md:justify-items-start">
        ...
        <div>
          ...
          <div className="flex flex-col items-center md:items-start gap-2 sm:gap-4 text-[11px] sm:text-sm text-muted-foreground font-medium">
            <span className="flex items-center gap-2 sm:gap-3"><Phone className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary/60 shrink-0" /> +91 86680 54205</span>
