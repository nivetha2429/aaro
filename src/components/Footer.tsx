    ...
    <div className="container mx-auto px-3 sm:px-4 py-5 sm:py-8 pb-16 md:pb-8">
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8 text-left">
        <div>
          ...
          <p className="text-muted-foreground text-[11px] sm:text-xs leading-relaxed max-w-xs">Your one-stop shop for premium phones and laptops at unbeatable prices.</p>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-x-1 gap-y-1.5 sm:gap-x-2 sm:gap-y-3 text-[11px] sm:text-sm font-bold">
            ...
            <Link to="/offers" className="text-muted-foreground hover:text-primary transition-all">Offers</Link>
        ...
        <div>
          ...
          <div className="flex flex-col gap-2 sm:gap-4 text-[11px] sm:text-sm text-muted-foreground font-medium">
